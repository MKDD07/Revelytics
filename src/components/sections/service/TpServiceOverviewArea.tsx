...
export const TpServiceOverviewArea: React.FC<TpServiceOverviewAreaProps> = ({ service }) => {
  return (
<>
  {/* tp-service-overview-area-start */}
        ...
        <div className="col-lg-5">
          <div className="tp-service-details-content mb-40 mr-115">
            <p className="tp-service-details-dec mb-45">
              ...
              visually and strategically represents a business. It includes logo
              design, color schemes, typography, and brand messaging to ensure
            ...
            <ul>
              <li>
                ...
                <p>
                  Discovery &amp; Research – Understanding your business,
              ...
              <li>
                <i className="fa-regular fa-circle-check" />
                <p>
                  Concept Development – Creating initial branding concepts and
                  design ideas.
                </p>
              </li>
              <li>
                <i className="fa-regular fa-circle-check" />
                <p>
                  Refinement &amp; Testing – Perfecting the visuals and ensuring
              ...
              <li>
                <i className="fa-regular fa-circle-check" />
                <p>
                  Final Implementation – Delivering all branding assets with a
