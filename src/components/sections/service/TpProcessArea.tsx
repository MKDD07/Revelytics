          ...
          <div className="row">
            <div className="col-lg-3 col-md-6 col-sm-6">
              ...
              >
                ...
                <h3 className="tp-process-title mb-20">
                  Research
                  <br /> And Analysis
                </h3>
                <p className="tp-process-dec">
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              ...
              >
                ...
                <p className="tp-process-dec">
                  Transform wireframes into high-
                  <br /> fidelity UI designs.
                </p>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 col-sm-6">
              ...
              >
                ...
                <p className="tp-process-dec">
                  Conduct usability testing to gather
                  <br /> user feedback.
                </p>
              </div>
            </div>
