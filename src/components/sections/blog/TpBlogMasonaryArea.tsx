          ...
          <div className="tp-blog-masonary-content">
            <div className="row gx-60">
              <div className="col-xl-6 col-lg-12 col-md-6">
                <div className="cs-blog-item mb-70">
                  <div className="cs-blog-thumb fix p-relative mb-25">
                    <img
                      className="w-100"
                      src="assets/img/blog/standard-grid/thumb.jpg"
                      alt=""
                    />
                    <a href="#" className="cs-blog-tag">
                      Branding
                    </a>
                  </div>
                  <h4 className="cs-blog-title tp-ff-sequel-semi-bold">
                    ...
                    >
                      Your marketplace dreams <br /> we shape them.
                    </a>
                  </h4>
                </div>
              </div>
              <div className="col-xl-6 col-lg-12 col-md-6">
                <div className="cs-blog-item mb-70">
                  <div className="cs-blog-thumb fix p-relative mb-25">
                    <img
                      className="w-100"
                      src="assets/img/blog/standard-grid/thumb-2.jpg"
                      alt=""
                    />
                    <a href="#" className="cs-blog-tag">
                      Web Design
                  ...
                  <h4 className="cs-blog-title tp-ff-sequel-semi-bold">
                    <a
                      ...
                      className="common-underline"
                    >
                      Where design meets your platform becomes.
                    </a>
                  </h4>
                </div>
              </div>
              <div className="col-xl-6 col-lg-12 col-md-6">
                <div className="cs-blog-item mb-70">
                  <div className="cs-blog-thumb fix p-relative mb-25">
                    <img
                      className="w-100"
                      src="assets/img/blog/standard-grid/thumb-3.jpg"
                      alt=""
                    />
                    <a href="#" className="cs-blog-tag">
                      Development
                  ...
                  <h4 className="cs-blog-title tp-ff-sequel-semi-bold">
                    <a
                      ...
                      className="common-underline"
                    >
                      This isn’t just design design makes reimagined.
                    </a>
                  </h4>
                </div>
              </div>
              <div className="col-xl-6 col-lg-12 col-md-6">
                <div className="cs-blog-item mb-70">
                  <div className="cs-blog-thumb fix p-relative mb-25">
                    <img
                      className="w-100"
                      src="assets/img/blog/standard-grid/thumb-4.jpg"
                      alt=""
                    />
                    <a href="#" className="cs-blog-tag">
                      Branding
              ...
              <div className="col-xl-6 col-lg-12 col-md-6">
                <div className="cs-blog-item mb-70">
                  <div className="cs-blog-thumb fix p-relative mb-25">
                    <img
                      className="w-100"
                      src="assets/img/blog/standard-grid/thumb-5.jpg"
                      alt=""
                    />
                    <a href="#" className="cs-blog-tag">
                      Web Design
              ...
              <div className="col-xl-6 col-lg-12 col-md-6">
                <div className="cs-blog-item mb-70">
                  <div className="cs-blog-thumb fix p-relative mb-25">
                    <img
                      className="w-100"
                      src="assets/img/blog/standard-grid/thumb-6.jpg"
                      alt=""
                    />
                    <a href="#" className="cs-blog-tag">
                      Development
              ...
              <div className="col-xl-6 col-lg-12 col-md-6">
                <div className="cs-blog-item mb-70">
                  <div className="cs-blog-thumb fix p-relative mb-25">
                    <img
                      className="w-100"
                      src="assets/img/blog/standard-grid/thumb-7.jpg"
                      alt=""
                    />
                    <a href="#" className="cs-blog-tag">
                      Web Design
              ...
              <div className="col-xl-6 col-lg-12 col-md-6">
                <div className="cs-blog-item mb-70">
                  <div className="cs-blog-thumb fix p-relative mb-25">
                    <img
                      className="w-100"
                      src="assets/img/blog/standard-grid/thumb-8.jpg"
                      alt=""
                    />
                    <a href="#" className="cs-blog-tag">
                      Development
                ...
                <div className="sidebar-widget-author">
                  <div className="sidebar-widget-author-img d-flex align-items-center">
                    ...
                    <div className="sidebar-widget-author-content">
                      <h4 className="sidebar-widget-author-name mb-0">
                        Kate Johnson
                      </h4>
                  ...
                  <ul>
                    <li>
                      <a
                        ...
                        href="blog-grid-with-sidebar-light.html"
                      >
                        Articles
                        <span>08</span>
                      </a>
                ...
                <div className="rc-post-wrap">
                  <div className="rc-post d-flex align-items-center">
                    <div className="rc-post-thumb">
                      <a href="blog-details-light.html">
                        <img
                          src="assets/img/blog/blog-standard/blog-rp-1.jpg"
                          alt=""
                        />
                      </a>
                    </div>
                  ...
                  <div className="rc-post d-flex align-items-center">
                    <div className="rc-post-thumb">
                      <a href="blog-details-light.html">
                        <img
                          src="assets/img/blog/blog-standard/blog-rp-2.jpg"
                          alt=""
                        />
                      </a>
                    </div>
                  ...
                  <div className="rc-post d-flex align-items-center">
                    <div className="rc-post-thumb">
                      <a href="blog-details-light.html">
                        <img
                          src="assets/img/blog/blog-standard/blog-rp-3.jpg"
                          alt=""
                        />
                      </a>
                    </div>
                    <div className="rc-post-content">
                      ...
                      <h3 className="rc-post-title">
                        <a
                          ...
                          className="common-underline"
                        >
                          Starting seo as your home business
                        </a>
                      </h3>
                      <div className="rc-post-meta">
                        <span>July 15, 2023</span>
